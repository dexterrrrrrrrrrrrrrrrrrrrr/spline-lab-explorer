    ...
    const draw = () => {
      ...
      cells.forEach((cell, index) => {
        if (cell.dividing) {
          ...
          gradient1.addColorStop(0, getCanvasColor('--accent', 0.8));
          gradient1.addColorStop(1, getCanvasColor('--primary'));
          
          ctx.fillStyle = gradient1;
          ctx.beginPath();
          ctx.arc(cell.x - offset, cell.y, cell.radius, 0, Math.PI * 2);
          ctx.fill();
          ctx.strokeStyle = getCanvasColor('--primary');
          ctx.lineWidth = 2;
          ctx.stroke();
          ...
          gradient2.addColorStop(0, getCanvasColor('--accent', 0.8));
          gradient2.addColorStop(1, getCanvasColor('--secondary'));
          
          ctx.fillStyle = gradient2;
          ctx.beginPath();
          ctx.arc(cell.x + offset, cell.y, cell.radius, 0, Math.PI * 2);
          ctx.fill();
          ctx.strokeStyle = getCanvasColor('--secondary');
          ctx.lineWidth = 2;
          ctx.stroke();
          ...
          gradient.addColorStop(0, getCanvasColor('--accent', 0.8));
          gradient.addColorStop(0.7, getCanvasColor('--primary'));
          gradient.addColorStop(1, getCanvasColor('--primary', 0.5));
          ...
          // Draw nucleus
          ctx.fillStyle = getCanvasColor('--secondary');
          ctx.beginPath();
